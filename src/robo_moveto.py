...
def moveto(x, y, z, a, b, c, obj_list=None):
    ...
    if P2z1 >= P2z2:
        P2 = np.array(KE_xtilde * P2x1 + KE_ztilde * P2z1)
    else:
        P2 = np.array(KE_xtilde * P2x2 + KE_ztilde * P2z2)
    ...
    if np.allclose(crossVA2VA3, rotax3):
        sign = 1
    else:
        sign = -1
    ...
    if proj_ytilde > 0 and proj_ztilde > 0:  # Quadrant I
        ...
        raise Exception("Failed to determine quadrant in E4yz!")
